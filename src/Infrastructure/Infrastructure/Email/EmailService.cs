...
namespace AspNetCoreAngular.Infrastructure.Email
{
    public class EmailService : IEmailService
    {
        ...
        private string GetBaseTemplate(string bodyTemplateName)
        {
            ...
            var baseTemplateStream = assembly.GetManifestResourceStream("AspNetCoreAngular.Infrastructure.Email.Templates.BaseTemplate.html");
            using var baseReader = new StreamReader(baseTemplateStream, Encoding.UTF8);
            var baseTemplate = baseReader.ReadToEnd();

            var bodyTemplateStream = assembly.GetManifestResourceStream($"AspNetCoreAngular.Infrastructure.Email.Templates.{bodyTemplateName}.html");
