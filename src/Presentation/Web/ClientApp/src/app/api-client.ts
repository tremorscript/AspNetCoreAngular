...
export class AppClient implements IAppClient {
  ...
  setLanguage(culture: string | null | undefined): Observable<FileResponse> {
    ...
    if (culture !== undefined && culture !== null) url_ += 'culture=' + encodeURIComponent('' + culture) + '&';
    url_ = url_.replace(/[?&]$/, '');
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<ApplicationDataViewModel>>(<any>_observableThrow(response_));
        }),
      );
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<CategoriesListVm>>(<any>_observableThrow(response_));
        }),
      );
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<CustomersListVm>>(<any>_observableThrow(response_));
        }),
      );
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<CustomerDetailVm>>(<any>_observableThrow(response_));
        }),
      );
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<EmployeesListVm>>(<any>_observableThrow(response_));
        }),
      );
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<EmployeeDetailVm>>(<any>_observableThrow(response_));
        }),
      );
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return <Observable<ProductsListVm>>(<any>_observableThrow(response_));
        }),
      );
  }
    ...
    if (_data) {
      if (_data['content']) {
        ...
        for (let key in _data['content']) {
          if (_data['content'].hasOwnProperty(key)) (<any>this.content)![key] = _data['content'][key];
        }
      }
      this.cookieConsent = _data['cookieConsent'];
      if (Array.isArray(_data['cultures'])) {
        this.cultures = [] as any;
        for (let item of _data['cultures']) this.cultures!.push(CulturesDisplayViewModel.fromJS(item));
      }
  ...
  toJSON(data?: any) {
    ...
    if (this.content) {
      ...
      for (let key in this.content) {
        if (this.content.hasOwnProperty(key)) (<any>data['content'])[key] = this.content[key];
      }
    }
    data['cookieConsent'] = this.cookieConsent;
    if (Array.isArray(this.cultures)) {
      data['cultures'] = [];
      for (let item of this.cultures) data['cultures'].push(item.toJSON());
    }
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['categories'])) {
        ...
        for (let item of _data['categories']) this.categories!.push(CategoryDto.fromJS(item));
      }
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['customers'])) {
        ...
        for (let item of _data['customers']) this.customers!.push(CustomerLookupDto.fromJS(item));
      }
    }
  }
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['employees'])) {
        ...
        for (let item of _data['employees']) this.employees!.push(EmployeeLookupDto.fromJS(item));
      }
    }
  }
...
export class EmployeeDetailVm implements IEmployeeDetailVm {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['territories'])) {
        ...
        for (let item of _data['territories']) this.territories!.push(EmployeeTerritoryDto.fromJS(item));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.territories)) {
      data['territories'] = [];
      for (let item of this.territories) data['territories'].push(item.toJSON());
    }
    return data;
  }
}
